...
func (c *pluginClient) GetAssets(ctx context.Context, in *GetAssetsRequest, opts ...grpc.CallOption) (*GetAssetsResponse, error) {
...
func (UnimplementedPluginServer) GetAssets(context.Context, *GetAssetsRequest) (*GetAssetsResponse, error) {
...
var Plugin_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "plugin/proto/integration_pack.proto",
}
